...
class ParseParams:
    ...
    def __init__(self):
        ...
        parser = argparse.ArgumentParser(description = "Script to automate the calibration. \n ./AutoCalibrate --videoplayback_build ./VideoPlayback_ECON_vx.y.z \n when camera id's are already present in CameraStartUpJson \n ./AutoCalibrate --videoplayback_build ./VideoPlayback_ECON_vx.y.z --skip_camera_id_mapping",formatter_class=argparse.RawTextHelpFormatter)
        ...
        parser.add_argument("--front_ratio_with_side_cam_offset_min",type = float,default = 0.4,help = "min ratio to accept with side camera offset. (default : 0.5)")
        parser.add_argument("--front_ratio_with_side_cam_offset_max",type = float,default = 0.6,help = "max ratio to accept with side camera offset. (default : 0.53)")
